                    ...
                    <div class="row align-items-center position-relative">
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="header-logo">
                                <a href="index.html"><img src="{{URL::asset('front-end/assets/images/logo/logo.png')}}" alt="Site Logo" /></a>
                            </div>
                        </div>
                        <!-- Header Logo End -->
                                        ...
                                        <ul class="mega-menu">
                                            ...
                                            <li class="mega-menu-col">
                                                <div class="megamenu-image">
                                                    <a href="shop.html">
                                                        <img class="fit-image" src="{{URL::asset('front-end/assets/images/header/mega-menu.png')}}" alt="Megamenu Image">
                                                    </a>
                                                </div>
                                            </li>
                                        </ul>
